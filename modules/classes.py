...
class Leader_Skill_Info:
    ...
    cat_list = ['DB Saga (34)', 'Saiyan Saga (86)', 'Planet Namek Saga (14)', 'Androids/Cell Saga (38)', 'Majin Buu Saga (9)',
                'Future Saga (19)', 'Universe Survival Saga (6)', 'Shadow Dragon Saga (2)', 'Pure Saiyans (17)', 'Hybrid Saiyans (5)',
                ...
                'Power Absorption (59)', 'Kamehameha (39)', 'Realm of Gods (8)', 'Full Power (20)', 'Giant Ape Power (60)', 'Majin Power (53)',
                'Powerful Comeback (67)', 'Power of Wishes (90)', 'Miraculous Awakening (66)', 'Corroded Body and Mind (64)', 'Rapid Growth (54)',
                ...
                'Representatives of Universe 7 (22)', 'Universe 11 (56)', 'GT Heroes (72)', 'GT Bosses (73)', 'Super Heroes (88)',
                'Movie Heroes (29)', 'Movie Bosses (16)', 'Turtle School (65)', 'World Tournament (3)', 'Earth-Bred Fighters (89)',
                'Low-Class Warrior (11)', 'Gifted Warriors (68)', 'Otherworld Warriors (44)', 'Resurrected Warriors (7)',
                'Space-Traveling Warriors (62)', 'Time Travelers (26)', 'Dragon Ball Seekers (25)', 'Storied Figures (71)',
                'Legendary Existence (77)', 'Saviors (57)', 'Defenders of Justice (70)', 'Revenge (48)', 'Target: Goku (43)',
